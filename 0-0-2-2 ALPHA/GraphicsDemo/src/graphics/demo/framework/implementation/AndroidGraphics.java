 ...
 * and modified slightly again by Ben Winchester
 */
...
public class AndroidGraphics implements Graphics 
{
	...
	@Override
	public void drawText(String text, int x, int y, int size, int color, Typeface font, int strokeWidth)
	{
		paint.setColor(color);
	...
	public void drawChar(char[] letters, int x, int y, int index, int color, int textSize)
	{
		paint.setColor(color);
